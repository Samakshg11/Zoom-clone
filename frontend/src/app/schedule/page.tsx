...
import {
  Calendar as CalendarIcon, ArrowLeft, Clock, CheckCircle2, Loader2, Copy, Check, Video,
  ...
  return (
    <div className="min-h-screen bg-[#F7F8FA] flex flex-col font-sans text-gray-900">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Form Content Area */}
        <main className="flex-1 overflow-y-auto max-w-2xl w-full mx-auto px-4 py-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#0E71EB] focus:bg-white transition-all text-gray-900"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm font-normal focus:outline-none focus:ring-2 focus:ring-[#0E71EB] focus:bg-white transition-all text-gray-900"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-[#0E71EB] focus:bg-white transition-all text-gray-900"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-[#0E71EB] focus:bg-white transition-all text-gray-900"
                      >
                  ...
                  <div className="pt-3 border-t border-gray-100 flex items-center justify-end gap-3">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="px-6 py-2.5 bg-[#0E71EB] hover:bg-[#0059be] text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center gap-2"
                    >
                      {loading ? (
                        <>
              ...
              <div className="space-y-6 text-center animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5 text-left space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-200/60">
                    <div>
                      ...
                      <p className="font-mono font-bold text-sm text-[#0E71EB]">{scheduledMeeting.meeting_code}</p>
                    </div>
                    <div>
                ...
                <div className="flex justify-center gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-[#0E71EB] hover:bg-[#0059be] text-white font-bold text-xs rounded-xl transition-all shadow-xs flex items-center gap-2"
                  >
